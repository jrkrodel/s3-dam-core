...
declare type StrictSanityDocument = Pick<SanityDocument, '_id' | '_rev' | '_type' | '_createdAt' | '_updatedAt'>;
 ...
 */
declare type CleanUpUpload = () => void;
...
export interface SanityUpload extends StrictSanityDocument, Partial<AudioMetadata>, Partial<VideoMetadata>, VendorUpload {
    _type: string;
    fileName?: string;
    contentType?: string;
    fileSize?: number;
...
export declare type MediaFile = SanityUpload | AssetReference;
...
export declare type FileMetadata = AudioMetadata | VideoMetadata;
export {};
